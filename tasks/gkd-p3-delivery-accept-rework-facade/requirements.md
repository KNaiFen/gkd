...
- 用户已授权按编排输入面收敛总计划继续实施 P3。
- 保留 explicit merge authorization、independent review 和 optional pack 选择；不把这些不可推导的决定自动化。

### Fixed baseline

- trusted main：`6f088c819cf5c203404ad031ac2de1aec7c6d702`

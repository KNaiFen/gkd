...
当前仓库提供可扩展的 development bundle foundation、确定性任务核心、固定角色/路由核心、project-scoped automatic runtime bridge，以及由仓库 policy 驱动的 GitHub fixed-head CI monitor。默认路线仍为 manual，candidate-facing task claim 与公开 role automatic CLI 均 fail-closed；生产安装与 AIO 接入不在本结果内。

...
class ReleaseCandidateContracts(unittest.TestCase):
    ...
    def test_stable_version_propagates_and_nonstable_versions_fail_closed(self) -> None:
        candidate = {"version":"0.1.3","sourceSha":"a"*40,"bundleDigest":"b"*64,"evidenceDigest":"c"*64,"traceability":self.traceability,"layers":["L0","L1","L2","L3","L4"],"sandboxRepository":"github.com/KNaiFen/gkd-sandbox"}
        self.assertEqual("v0.1.3", promotion_request(build_release_candidate(candidate))["tagName"])
        for version in ("0.1", "0.01.3", "0.1.3-rc.1", "v0.1.3", ""):

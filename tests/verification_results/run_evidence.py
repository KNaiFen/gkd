...
import gkd_bundle
from gkd_task.results import CORE_SCOPE_NAMES, CanonicalResultError, canonical_bytes, digest_object, load_canonical_results
...
def main() -> int:
    ...
    try:
        ...
        evidence = {
            ...
            "task": "GKD-O3",
            "totalTests": sum(len(consumed[scope]["tests"]) for scope in CORE_SCOPE_NAMES),

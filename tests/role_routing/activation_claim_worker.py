...
from gkd_role.activation import TrustedActivationEvidenceProvider
...
try:
    ...
    provider = TrustedActivationEvidenceProvider(runtime, args.activation, role_catalog(args.bundle_root, locked_bundle_digest(args.bundle_root)))

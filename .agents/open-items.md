...
- [ ] `GKD-M2-C`：初始 claim 以 `RUNTIME_EVIDENCE_UNAVAILABLE` fail-closed，旧 offer/envelope 已由 main 撤销；PR #7 第二轮 fixed head `b97dce72a21a719b616f418b7e23638bce507f0c` 的 v3 acceptance、default Python bytecode 与 `source.toml` symlink 缺口已由 `d3d8ea7a6d594caac843be91f7f2e651906bfacd` / `bb1992998af62119fde4eef1b0e9972fe757b3d7` 修复。30 项 M2-C 合同默认环境双次一致、git archive 纯净副本 30/30、全部保留回归通过；candidate bundle/evidence digest 为 `3a95bab5083bd2ff37e29ef4f367860bb3f80a63265ec8163334da310e3c556f` / `5e3a9b2efbafb75986c24f5f15f93c99f734bde1b716f23a58ca7c72ed11db13`。task state 仍为 planning/epoch 1/revision 5 且无 claim/deliver。PR #7 等待新 fixed-head 独立验收；例外不得延伸到 M3，验收前不得把输出 bundle 当作 accepted runtime upgrade，不得启动 fresh main/M3 或退回 generic worker。
  - Latest remediation: fixed head `d0d24fcea80d926fb4b9d29cfb93a3e58e1eb516` 的 AC7 catalog 缓存问题已由 `c5bf34c4f8623c1720cd4ddd990811cc29840295` / `0c2578ab4a6d98634dbc2ba13cf89ef1e6719bc3` 修复。bridge 在 prepare/claim/recover 重新验证实际 bundle；32 项 M2-C 双 evidence 与 archive 副本、104 task-core、70 role-routing、53 foundation、47 watcher-core、15 live-negative 通过。candidate bundle/evidence digest 为 `05288d5b09bdd8b4703a45d8a300d9466ad59f6b414d8eb5684c4a214ecfaaad` / `ab6efbc3cded637edc1fd0acd155958a3949566d48282fa1c4bfa81b266bbb82`，等待新 fixed-head 独立验收。

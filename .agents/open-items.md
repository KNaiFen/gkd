...
- [ ] `GKD-M5-A`：epoch 5 返工已完成 L1 property、L2 fake-GitHub subprocess、L3 forward-eval fixture、L4 sandbox contract 和 16 项按决定区分且指向 runnable verifier test 的正/反/mutation traceability；当前 `scripts/gkd-verify --base-sha 0c5d33e1125ed22100c9c3f1c8554427a480caec` 通过 410 项，双次 M5 evidence digest 均为 `a404f839913b209d6e8337949dcfc38003f4cd85b1b90e23ae1e1c935e658c94`。等待 implementation commit、delivery、固定 head CI、独立验收及 post-merge L3/L4/promotion。

...
- [ ] `GKD-M2-C`：初始 claim 以 `RUNTIME_EVIDENCE_UNAVAILABLE` fail-closed，旧 offer/envelope 已由 main 撤销；PR #7 首轮 fixed head `b512a2aa644992c88ae2a2012d1322573a9ead0b` 的四项阻塞已由 implementation/evidence commit `e72803783b2abbf453a90ee1ebc89c911cd12c57` 修复。24 项 M2-C 合同双次一致、全部保留回归通过，candidate bundle/evidence digest 为 `c385b10ca631b94c8e26c4f1accfdd8a3c9208b0cacfc1e320b52bbe631c9650` / `5b8f824d7fb98b82c7db805e7cebea848c4185f8a4c078e969998a48f7d5ef13`；task state 仍为 planning/epoch 1/revision 5 且无 claim/deliver。PR #7 等待新 fixed-head 独立验收；例外不得延伸到 M3，验收前不得把输出 bundle 当作 accepted runtime upgrade，不得启动 fresh main/M3 或退回 generic worker。

...
- [ ] `GKD-P1` 候选提供 `0.1.1` production migration plan/apply/doctor/rollback/recover，temporary `migration-*` 继续拒绝生产根目录。候选 bundle digest 为 `a58373aaae9c78f164e358393df089c51949e731df3267cf8159d57d321bb629`，固定 base local verifier 已通过 418 项；仍待 delivery、PR fixed-head CI 和独立验收。不得据此实际写入生产目录、AIO、tag 或 Release。

...
`gkd-task` supports Python 3.9 or newer for executor status, doctor, and task
contracts. Project staging and the automatic runtime bridge retain their
separate documented interpreter requirements.

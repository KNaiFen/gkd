...
class ActivationEvidenceProvider:
    """Reads only catalog-pinned machine-local activation records."""
    ...
    def observe(self, purpose: str, expected: dict[str, Any]) -> dict[str, Any]:
        ...
        if activation["providerName"] != self.provider_name or activation["providerDigest"] != self.provider_digest:

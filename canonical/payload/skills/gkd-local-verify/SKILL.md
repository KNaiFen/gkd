...
3. Run only `scripts/gkd-verify --base-sha <full-base-sha>`, the repository's versioned local verification entry. Do not infer a package manager, dependency install, build, server, or large artifact command.

...
6. Commit and push the task branch, update its existing PR when authorized, write delivery facts, and stop at the fixed head. Delivery is writerless and frozen; any later rejection requires trusted rework plus a new offer, activation, and claim before implementation may resume.
